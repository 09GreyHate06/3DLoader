...
public class RenderingSystem extends EntitySystem {
    ...
    public void addedToEngine(Engine engine) {
        ...
        data.put((byte)(0xff));
        data.flip();
        AssetManager.loadAndAddTexture2D("default", data, 1, 1, 4,
        ...
        for(var entity : _renderables){
            ...
            if(meshRenderer.receiveLight){
                ...
                if(material.diffuseMap != null)
                    ...
                    AssetManager.getTexture2D("default").bind(0);

                if(material.specularMap != null)
                    material.specularMap.bind(1);
                else
                    AssetManager.getTexture2D("default").bind(1);

                if(material.normalMap != null){
                    material.normalMap.bind(2);
                    enableNormalMap = true;
                } else {
                    AssetManager.getTexture2D("default").bind(2);
                }
